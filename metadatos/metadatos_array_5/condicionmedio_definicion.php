...
$this->array_data[$tabla.'_definicion']['id'.$tabla.'_rotulo'] = 'C&oacute;digo de la Condici&oacute;n del Medio';
$this->array_data[$tabla.'_definicion'][$tabla.'_rotulo'] = 'Condici&oacute;n del Medio';
