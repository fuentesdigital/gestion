...
$this->array_data[$tabla.'_definicion']['id'.$tabla.'_rotulo'] = 'C&oacute;digo del Tipo de Identificador';
$this->array_data[$tabla.'_definicion'][$tabla.'_rotulo'] = 'Tipo de Identificador';
