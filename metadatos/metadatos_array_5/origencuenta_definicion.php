...
$this->array_data[$tabla.'_definicion']['id'.$tabla.'_rotulo'] = 'C&oacuet;igo del Origen de la Cuenta';
$this->array_data[$tabla.'_definicion'][$tabla.'_rotulo'] = 'Origen de la Cuenta';
