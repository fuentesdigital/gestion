...
$this->array_data[$tabla.'_definicion']['id'.$tabla.'_rotulo'] = 'C&oacute;digo del Pa&iacute;s';
$this->array_data[$tabla.'_definicion'][$tabla.'_rotulo'] = 'Nombre del Pa&iacute;s';
