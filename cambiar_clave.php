...
$RsEditar = mysqli_query($query_RsEditar, CONEXION)  or trigger_error(mysql_error(),E_USER_ERROR);
...
$Rsdepartamento = mysqli_query($query_Rsdepartamento, CONEXION)  or trigger_error(mysql_error(),E_USER_ERROR);
...
$RsSexo = mysqli_query($query_RsSexo, CONEXION)  or trigger_error(mysql_error(),E_USER_ERROR);
