...
<td width="312"><input name="'.$parametros_arr['campo'].'" type="checkbox" '.$parametros_arr['chequear_flag'] .'  class="cheque" value="1" size="'.$parametros_arr['size_ctrl'].'"><input name="campos[]" type="hidden" value="'.$parametros_arr['campo'].'"></td>
</tr>';
}
?>